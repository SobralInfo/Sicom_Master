...
type
  TfrmTelaDePedido = class(TForm)
    ...
    qryItensBAIXADO_ESTOQUE: TStringField;
  ...
  public
    ...
    var idPedido, idProduto, idCliente, idFuncionario: integer;
        fatorUnidade, estoqueAtual: double;
...
begin
   ...
   Try
      ...
      if ((frmPrincipal.qryParametrosCRITICAR_ESTOQUE.AsString = 'S') AND
          (edtQuantidade.AsFloat > estoqueAtual) AND
          (frmPrincipal.qryProdutosKIT.AsString = 'N')) Then Begin

          prcMsgAdv('Produto com quantidade insuficiente.');
          Exit;
