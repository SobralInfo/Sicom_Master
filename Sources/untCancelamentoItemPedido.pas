...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Data.DB, Vcl.StdCtrls, Vcl.Grids, untTelaDePedido,
  Vcl.DBGrids, Vcl.ExtCtrls, Vcl.Buttons, unitConfiguracoes, BaseLocalProdutosController,
...
begin
   ...
   valor := frmTelaDePedido.qryItensVALOR_TOTAL.AsFloat;
   ...
   if frmTelaDePedido.qryItensBAIXADO_ESTOQUE.AsString = 'S' then
     TBaseLocalProdutosController.GravarMovimetacaoProduto(frmTelaDePedido.qryItensID_PRODUTO.AsInteger ,
                                                          (frmTelaDePedido.qryItensQUANTIDADE.AsFloat),
                                                          0,
                                                          'V',
                                                          0,
                                                          frmTelaDePedido.qryItensID_PEDIDO.AsInteger);
...
procedure TfrmCancelamentoItemPedido.FormShow(Sender: TObject);
begin
   frmTelaDePedido.qryItens.close;
   frmTelaDePedido.qryItens.Open;
   frmTelaDePedido.qryItens.Last;
