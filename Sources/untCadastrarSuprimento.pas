...
begin
   ...
   Try
      ...
      suprimento.id_movimento := frmPrincipal.idMovimento;
      suprimento.idFomaPg     := lkpFormaPG.KeyValue;
      suprimento.FormaPG      := Trim(lkpFormaPG.Text);
...
procedure TfrmCadastrarSuprimento.FormCreate(Sender: TObject);
begin
   ...
   //frmPrincipal.qryFormaPG.SQL.Add(' SELECT 0 AS ID, ''A'' status, ''FIADO'' AS nome, null id_original, ''N'' AS permite_troco, NULL AS FIDELIDADE FROM configuracoes ');
