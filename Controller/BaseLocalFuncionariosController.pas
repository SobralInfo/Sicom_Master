...
begin
   ...
   Try
      ...
      query.SQL.Add(' (  ');
      query.SQL.Add(' id, status, codigo, nome, percentual_comissao  ');
      query.SQL.Add(' )   ');
...
class function TBaseLocalFuncionariosController.retornarGenerator: integer;
Var query: TFDQuery;
begin
   ...
   Try
      ...
      query.Close;
      query.SQL.Add('SELECT gen_id(GEN_FUNCIONARIOS_ID, 1) AS id from rdb$database;');
      query.Open;
