...
Type TBaseLocalPedidoCabecalhoController = class
   ...
   class procedure MudarStBaixaEstPedido(pedido : String);
...
begin
   ...
   Try
      ...
      Try
         ...
         MudarStBaixaEstPedido(pedido.id.ToString);
...
class procedure TBaseLocalPedidoCabecalhoController.MudarStBaixaEstPedido(pedido: String);
Var query: TFDQuery;
begin
   ...
   Try
      ...
      query.Close;
      query.SQL.Add('update PEDIDO_DETALHE set BAIXADO_ESTOQUE = ''S'' WHERE ID_PEDIDO = '+pedido);
      query.ExecSQL;
      frmPrincipal.ConexaoLocal.Commit;
