...
Type TBaseLocalPedidoDetalheVO = class
  private
    ...
    procedure SetBaixadoEstoque(const Value: string);
  published
   ...
   property BaixadoEstoque: string read FBaixadoEstoque write SetBaixadoEstoque;
...
procedure TBaseLocalPedidoDetalheVO.SetBaixadoEstoque(const Value: string);
begin
  FBaixadoEstoque := Value;
end;
